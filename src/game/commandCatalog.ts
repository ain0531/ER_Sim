...
export const commandCatalog: BaseCommand[] = [
  { id: "airwayCheck", category: "A", label: "気道開通の確認", duration: 1 },
  ...
  { id: "neckVeinCheck", category: "B", label: "頸静脈怒張の確認", duration: 1 },
  { id: "subcutaneousEmphysemaCheck", category: "B", label: "皮下気腫の確認", duration: 1 },
  { id: "trachealDeviationCheck", category: "B", label: "気管偏位の確認", duration: 1 },
  { id: "chestPalpation", category: "B", label: "前胸部触診", duration: 1 },
  ...
  { id: "iv", category: "C", label: "ルート確保", duration: 10 },
  ...
  { id: "vasopressor", category: "C", label: "昇圧薬投与", duration: 20, repeatable: true },
  ...
  { id: "consciousnessCheck", category: "D", label: "意識レベルの確認", duration: 1 },
